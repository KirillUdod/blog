...
class BlogMainPage(models.Model):
    page_title = models.TextField(verbose_name=u'Содержимое тега title', help_text=u'тег title')
    page_description = models.TextField(verbose_name=u'Содержимое description страницы', help_text=u'meta description',
                                        blank=True)
    page_keywords = models.TextField(verbose_name=u'Содержимое keywords страницы', help_text=u'meta keywords',
                                     blank=True)
